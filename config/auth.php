...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Custom authentication routes for different user types
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Define which policies are used for authorization
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Settings for MFA if implemented
    |
    */
    ...
    'mfa' => [
        ...
        'issuer' => env('APP_NAME', 'School Management System'),
    ],
